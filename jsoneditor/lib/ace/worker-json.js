...
var console = {
	...
	if (n)
		return n.initialized || (n.initialized = !0, n.exports = n.factory().exports), n.exports;
	var r = t.split("/");
...
onmessage = function(e) {
	...
	if ([1, 2].splice(0).length != 2)
		if (! function() {
			...
			Array.prototype.splice = function(e, t) {
				var n = this.length;
				e > 0 ? e > n && ( e = n) : e ==
				void 0 ? e = 0 : e < 0 && ( e = Math.max(n + e, 0)), e + t < n || ( t = n - e);
			...
			Array.prototype.splice = function(e, t) {
				return arguments.length ? v.apply(this, [e ===
				void 0 ? 0 : e, t ===
				void 0 ? this.length - e : t].concat(u.call(arguments, 2))) : []
			}
		}
	...
	if (!Object.create) {
		...
		Object.prototype.__proto__ === null ? b = function() {
			...
			return n !==
			void 0 && Object.defineProperties(r, n), r
		}
	}
		...
		Object.defineProperty = function(t, n, r) {
			...
			if (f(r, "value"))
				if (d && (h(t, n) || p(t, n))) {
					var s = t.__proto__;
					t.__proto__ = o,
					delete t[n], t[n] = r.value, t.__proto__ = s
				} else
					t[n] = r.value;
			else {
				if (!d)
	...
	void 0, 0).length) {
		...
		String.prototype.split = function(e, t) {
			return e ===
			void 0 && t === 0 ? [] : _.apply(this, arguments)
		}
	}
	...
	function(e, t) {
		...
		return o = e, r = 0, i = " ", n = p(), c(), i && u("Syntax error"), typeof t == "function" ? function s(e, n) {
			...
			if (o && typeof o == "object")
				for (r in o)Object.hasOwnProperty.call(o, r) && ( i = s(o, r), i !== undefined ? o[r] = i :
				delete o[r]);
			return t.call(e, n, o)
		}({
			"" : n
